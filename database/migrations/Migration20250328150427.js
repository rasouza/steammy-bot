...
class Migration20250328150427 extends Migration {

  async up() {
    this.addSql(`create schema if not exists "steammy_bot";`);
    this.addSql(`create table "steammy_bot"."data" ("key" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "value" varchar(255) not null default '', constraint "data_pkey" primary key ("key"));`);
    ...
    this.addSql(`create table "steammy_bot"."guild" ("id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "prefix" varchar(255) null, "deleted" boolean not null default false, "last_interact" timestamptz not null, constraint "guild_pkey" primary key ("id"));`);
    ...
    this.addSql(`create table "steammy_bot"."subscription" ("id" varchar(255) not null, "platform" varchar(255) not null, "guild_id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, constraint "subscription_pkey" primary key ("id", "platform", "guild_id"));`);

    this.addSql(`create table "steammy_bot"."user" ("id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "last_interact" timestamptz not null, constraint "user_pkey" primary key ("id"));`);
...
exports.Migration20250328150427 = Migration20250328150427;
